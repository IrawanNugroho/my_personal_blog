        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header">Project
                    <button class="btn-small btn-success float-right" onclick="window.location='{{ route("projects.create") }}'">+</button>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <button type="button" class="btn-small btn-warning" onclick="window.location='{{ route("projects.edit", ["id" => $item->id]) }}'">Edit</button>
                                    </center>
                                </td>
                            </tr>
                            @endforeach
