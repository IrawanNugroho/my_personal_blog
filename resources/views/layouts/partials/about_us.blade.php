      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 ">
          <div class="div-img-bg">
            <div class="about-img">
              <img src="{{ asset('folio/images/me.jpg') }}" class="img-responsive" alt="me">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-7">
          <div class="about-descr">
            ...
            <p class="separator">
                My name is Irawan Setyo Adhi Nugroho. My parents call me Adhi. Since Irawan is my first name which listed on students list, therefore most of my friends call me as Irawan. I was graduated from Duta Wacana Christian University on Information Technology. Currenlty , I work as a programmer at Harian Kompas.
            </p>
